...
#' @return 				An integer vector the same length as \code{x}, with a 1 for every element that is different than the one after it, 
#' and a 0 for every element that is the same as the one after it.
#' @export
#' @examples 
