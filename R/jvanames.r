...
#' @param charvec	A character vector to be trimmed.
#' @return 			A character vector, the same length as \code{charvec}, but with all lower case, unique, and without underscores.
#' @export
