...
#' @return
#'   A 1 is added to the numeric vector of length 1, \code{jvamiscenv$tabcount},
...
#'   \code{\link[jvamisc]{para}}, \code{\link[jvamisc]{figu}},
...
tabl <- function(..., TAB=tab, rtf=doc, fontt=8, row.names=TRUE,
    tabc=jvamiscenv$tabcount, boldt=TRUE, newpage="none", omi=c(1, 1, 1, 1)) {
	if (newpage=="port") {
