...
#'   default \code{jvamiscenv$figcount}.
#' @param boldt
...
#' @return
#'   A 1 is added to the numeric vector of length 1, \code{jvamiscenv$figcount},
...
#' @seealso
#'   \code{\link[jvamisc]{startrtf}}, \code{\link[jvamisc]{heading}},
#'   \code{\link[jvamisc]{para}}, \code{\link[jvamisc]{tabl}},
...
figu <- function(..., FIG=fig, rtf=doc, figid="Figure ",
    fign=jvamiscenv$figcount, boldt=TRUE, capunder=TRUE, w=NULL, h=NULL,
