...
#' axis(1, at=julian(as.Date(paste(2005, 1:12, 1, sep="-")), origin=as.Date("2004-12-31"))-0.5, labels=FALSE)
#' axis(1, at=julian(as.Date(paste(2005, 1:12, 15, sep="-")), origin=as.Date("2004-12-31")), labels=month.abb, tick=FALSE)
#' axis(2)
#' box()
#'
#' ### contour plot ###
