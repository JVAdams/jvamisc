...
#' @details		All records with a missing value in either the numerator or the denominator are omitted from calculations.
#' @return 		A named vector with the sum of the numerators, the sum of the denominators, the ratio of the sums,
#'	the number of non-missing input pairs, and the standard deviation and 95% confidence interval of the ratio.
#' @export
