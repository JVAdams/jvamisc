...
#' @param varname
#'   A character scalar to be used as an identifier in the generated
#'   comment vector.  If NULL (default), the name of x will be used.
#'   If FALSE, no varname will be used in the comment.
#' @param pmissing
#'   A character vector of all possible values to be interpreted as missings
#'   (and, therefore, not be commented upon).
#' @param justindex
#'   A logical scalar indicating if the output should just be the index of
