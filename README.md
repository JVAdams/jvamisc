...
_U.S. Geological Survey_ (USGS) Computer Program **jvamisc** version 0.5.3.9001. 
Written by Jean V. Adams, [USGS - Great Lakes Science Center](http://www.glsc.usgs.gov/), Ann Arbor, Michigan, USA. 
Written in programming language R (R Core Team, 2016, www.R-project.org), version 3.3.3. 
