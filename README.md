...
_U.S. Geological Survey_ (USGS) Computer Program **jvamisc** version 1.0.0.9001. 
Written by Jean V. Adams, [USGS - Great Lakes Science Center](http://www.glsc.usgs.gov/), Ann Arbor, Michigan, USA. 
Written in programming language R (R Core Team, 2017, www.R-project.org), version 3.4.0. 
