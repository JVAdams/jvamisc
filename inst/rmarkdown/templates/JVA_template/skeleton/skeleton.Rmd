...
This is an [R Markdown](http://rmarkdown.rstudio.com) template for creating a Word document
...
You can write superscripts, R^2^, subscripts, X~ij~.  You can ~~cross things out~~.  And you can draw a horizontal line. 
